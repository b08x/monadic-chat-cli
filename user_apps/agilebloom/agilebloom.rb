...
class Agilebloom < MonadicApp
  DESC = "Monadic Chat app (agilebloom)"
  COLOR = "blue" # green/yellow/read/blue/magenta/cyan/white
  ...
  def initialize(openai_completion, research_mode: false, stream: true, params: {})
    ...
    template_json = TEMPLATES["normal/agilebloom"]
    template_md = TEMPLATES["research/agilebloom"]
    super(mode: mode,
          params: params,
